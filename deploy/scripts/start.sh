...
rims_api='http://rims.iptime.org:4500' \
api='http://rims.iptime.org:4600' \
kdt_api='http://rims.iptime.org:4700' \
unity='http://rims.iptime.org:4700' \
analysis_api='http://rims.iptime.org:4800' \
dbdata='http://rims.iptime.org:4800' \
synth_data='http://rims.iptime.org:4800' \
mrc_api='http://rims.iptime.org:4900' \
