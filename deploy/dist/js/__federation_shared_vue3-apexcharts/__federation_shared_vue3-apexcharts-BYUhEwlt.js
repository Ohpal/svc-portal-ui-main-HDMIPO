...
function b$1(t2) {
  return b$1 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t3) {
    return typeof t3;
  } : function(t3) {
...
var v = function() {
  ...
  return s(t2, [{ key: "shadeRGBColor", value: function(t3, e2) {
    ...
    return t3 && "object" === b$1(t3) && !Array.isArray(t3) && null != t3;
    ...
    if (null === t3 || "object" !== b$1(t3)) return t3;
...
}, E = "http://www.w3.org/2000/svg", Y = "http://www.w3.org/2000/xmlns/", H$1 = "http://www.w3.org/1999/xlink", O = { window: "undefined" == typeof window ? null : window, document: "undefined" == typeof document ? null : document };
function F$1() {
  return O.window;
}
let D = class {
};
const _$1 = {}, N = "___SYMBOL___ROOT___";
function W(t2, e2 = E) {
...
function V(t2) {
  ...
  if ("#document-fragment" === t2.nodeName) return new _$1.Fragment(t2);
  let e2 = P(t2.nodeName || "Dom");
  return "LinearGradient" === e2 || "RadialGradient" === e2 ? e2 = "Gradient" : _$1[e2] || (e2 = "Dom"), new _$1[e2](t2);
}
let U = V;
function q$1(t2, e2 = t2.name, i2 = false) {
  return _$1[e2] = t2, i2 && (_$1[N] = t2), S(Object.getOwnPropertyNames(t2.prototype)), t2;
}
let Z$1 = 1e3;
function $$1(t2) {
  return "Svgjs" + P(t2) + Z$1++;
}
function J$1(t2) {
  for (let e2 = t2.children.length - 1; e2 >= 0; e2--) J$1(t2.children[e2]);
  return t2.id ? (t2.id = $$1(t2.nodeName), t2) : t2;
}
function Q(t2, e2) {
  let i2, a2;
...
class Bt extends Rt {
  ...
  id(t2) {
    return void 0 !== t2 || this.node.id || (this.node.id = $$1(this.type)), this.attr("id", t2);
  }
  index(t2) {
...
Q(se, ae), A$1("Container", { ellipse: K$1(function(t2 = 0, e2 = t2) {
...
class he extends Vt {
  constructor(t2, e2) {
    super(G$1(t2 + "Gradient", "string" == typeof t2 ? null : t2), e2);
  }
  attr(t2, e2, i2) {
...
} }, Defs: { gradient: K$1(function(t2, e2) {
  return this.put(new he(t2)).update(e2);
}) } }), q$1(he, "Gradient");
class ce extends Vt {
  constructor(t2, e2 = t2) {
    super(G$1("pattern", t2), e2);
  }
  attr(t2, e2, i2) {
...
}, Wt.push(ue), A$1({ Container: { image: K$1(function(t2, e2) {
...
} }, Defs: { marker: K$1(function(t2, e2, i2) {
...
We.prototype.MorphArray = Ee, A$1({ Container: { path: K$1(function(t2) {
...
class Ge extends qt {
  constructor(t2, e2 = t2) {
    super(G$1("polygon", t2), e2);
  }
}
A$1({ Container: { polygon: K$1(function(t2) {
  return this.put(new Ge()).plot(t2 || new ge());
}) } }), Q(Ge, fe), Q(Ge, Be), q$1(Ge, "Polygon");
class je extends qt {
  constructor(t2, e2 = t2) {
    super(G$1("polyline", t2), e2);
  }
}
A$1({ Container: { polyline: K$1(function(t2) {
  return this.put(new je()).plot(t2 || new ge());
}) } }), Q(je, fe), Q(je, Be), q$1(je, "Polyline");
class Ve extends qt {
  constructor(t2, e2 = t2) {
    super(G$1("rect", t2), e2);
  }
}
Q(Ve, { rx: Zt, ry: $t }), A$1({ Container: { rect: K$1(function(t2, e2) {
...
} }), Q(Qe, { rx: Zt, ry: $t, from: ne, to: oe }), q$1(Qe, "Runner");
class si extends Vt {
  constructor(t2, e2 = t2) {
    super(G$1("svg", t2), e2), this.namespace();
  }
  defs() {
  ...
  namespace() {
    return this.isRoot() ? this.attr({ xmlns: E, version: "1.1" }).attr("xmlns:xlink", H$1, Y) : this.root().namespace();
  }
  removeNamespace() {
...
A$1({ Container: { nested: K$1(function() {
  return this.put(new si());
}) } }), q$1(si, "Svg", true);
let ri = class extends Vt {
  constructor(t2, e2 = t2) {
    super(G$1("symbol", t2), e2);
  }
};
A$1({ Container: { symbol: K$1(function() {
...
class oi extends qt {
  constructor(t2, e2 = t2) {
    super(G$1("text", t2), e2), this.dom.leading = this.dom.leading ?? new _t(1.3), this._rebuild = true, this._build = false;
  }
  leading(t2) {
...
Q(oi, ni), A$1({ Container: { text: K$1(function(t2 = "") {
  return this.put(new oi()).text(t2);
}), plain: K$1(function(t2 = "") {
  return this.put(new oi()).plain(t2);
}) } }), q$1(oi, "Text");
class li extends qt {
  constructor(t2, e2 = t2) {
    super(G$1("tspan", t2), e2), this._build = false;
  }
  dx(t2) {
...
Q(li, ni), A$1({ Tspan: { tspan: K$1(function(t2 = "") {
  const e2 = new li();
...
Q(hi, { x: Jt, y: Qt, cx: Kt, cy: te, width: ee, height: ie }), A$1({ Container: { circle: K$1(function(t2 = 0) {
  return this.put(new hi()).size(t2).move(0, 0);
}) } }), q$1(hi, "Circle");
class ci extends Vt {
  constructor(t2, e2 = t2) {
    super(G$1("clipPath", t2), e2);
  }
  remove() {
...
A$1({ Container: { clip: K$1(function() {
...
class di extends Gt {
  constructor(t2, e2 = t2) {
    super(G$1("foreignObject", t2), e2);
  }
}
A$1({ Container: { foreignObject: K$1(function(t2, e2) {
  return this.put(new di()).size(t2, e2);
}) } }), q$1(di, "ForeignObject");
var ui = Object.freeze({ __proto__: null, dmove: function(t2, e2) {
  return this.children().forEach((i2) => {
    let a2;
    try {
      a2 = i2.node instanceof F$1().SVGSVGElement ? new kt(i2.attr(["x", "y", "width", "height"])) : i2.bbox();
    } catch (t3) {
      return;
    }
...
Q(gi, ui), A$1({ Container: { group: K$1(function() {
...
class pi extends Vt {
  ...
  to(t2) {
    return this.attr("href", t2, H$1);
  }
}
Q(pi, ui), A$1({ Container: { link: K$1(function(t2) {
...
A$1({ Container: { mask: K$1(function() {
...
A$1({ Container: { textPath: K$1(function(t2, e2) {
  return t2 instanceof oi || (t2 = this.text(t2)), t2.path(e2);
}) }, Text: { path: K$1(function(t2, e2 = true) {
  const i2 = new mi();
  let a2;
  if (t2 instanceof We || (t2 = this.defs().path(t2)), i2.attr("href", "#" + t2, H$1), e2) for (; a2 = this.node.firstChild; ) i2.node.appendChild(a2);
  return this.put(i2);
}), textPath() {
  return this.findOne("textPath");
} }, Path: { text: K$1(function(t2) {
...
} } }), mi.prototype.MorphArray = Ee, q$1(mi, "TextPath");
class vi extends qt {
  constructor(t2, e2 = t2) {
    super(G$1("use", t2), e2);
  }
  use(t2, e2) {
    return this.attr("href", (e2 || "") + "#" + t2, H$1);
  }
}
A$1({ Container: { use: K$1(function(t2, e2) {
...
class wi extends Gt {
  constructor(t2) {
    super(G$1("filter", t2), t2), this.$source = "SourceGraphic", this.$sourceAlpha = "SourceAlpha", this.$background = "BackgroundImage", this.$backgroundAlpha = "BackgroundAlpha", this.$fill = "FillPaint", this.$stroke = "StrokePaint", this.$autoSetIn = true;
  }
  put(t2, e2) {
...
["blend", "colorMatrix", "componentTransfer", "composite", "convolveMatrix", "diffuseLighting", "displacementMap", "dropShadow", "flood", "gaussianBlur", "image", "merge", "morphology", "offset", "specularLighting", "tile", "turbulence"].forEach((t2) => {
  ...
  wi[e2 + "Effect"] = class extends ki {
    constructor(t3) {
      super(G$1("fe" + e2, t3), t3);
    }
    update(t3) {
      return i2.apply(this, t3), this;
    }
  }, wi.prototype[t2] = K$1(function(t3, ...i3) {
...
["funcR", "funcG", "funcB", "funcA"].forEach(function(t2) {
  const e2 = wi[P(t2)], i2 = K$1(function() {
...
const { defineComponent: Z, ref: b, onBeforeMount: _, onMounted: q, getCurrentInstance: K, onBeforeUnmount: $, toRefs: F, watch: c, h: G, nextTick: H } = await importShared("vue");
const A = [
  "animationEnd",
  "beforeMount",
  "mounted",
  ...
  emits: A,
  setup(a2, { emit: x2 }) {
    const g2 = b(null), t2 = b(null), f2 = (e2) => e2 && typeof e2 == "object" && !Array.isArray(e2) && e2 != null, S2 = (e2, n2) => {
