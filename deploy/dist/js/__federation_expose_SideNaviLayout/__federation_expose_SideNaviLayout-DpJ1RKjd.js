...
import axiosInstance, { k as useMessageStore, b as useAuthStore, d as useI18n, l as sessionLogout, g as getRefreshToken, M as Message, m as useLoadingStore, u as useNotificationStore, a as useProfileDialogStore, f as usePlatformStore, e as useMenuStore, c as getLogoutTime, n as getCommonIntervalTime } from "../__federation_expose_Axios/__federation_expose_Axios-BZVs7w6X.js";
import SideMenuItem, { b0 as templateRef, y as IN_BROWSER, p as propsFactory, av as convertToUnit, a8 as getCurrentInstance, bK as findChildrenWithProvide, e as consoleWarn, bL as SUPPORTS_INTERSECTION, u as useRtl, bM as parseAnchor, g as genericComponent, G as useProxiedModel, a as provideTheme, a0 as useTextColor, a1 as useBackgroundColor, aj as useRounded, l as clamp, b as useRender, m as makeThemeProps, A as makeTagProps, N as makeRoundedProps, c as makeComponentProps, a7 as getCurrentInstanceName, bg as useScopeId, am as useVariant, a9 as useToggleScope, r as refElement, ad as forwardRefs, o as omit, K as makeVariantProps, bh as makeVOverlayProps, b3 as VOverlay, an as genOverlays, ap as VDefaultsProvider, Y as VIcon, at as animate, bN as acceleratedEasing, au as standardEasing, bO as deceleratedEasing, bP as getTargetBox, as as nullifyTransforms, bQ as createList, bq as VListGroup, az as VListItem, bR as isPrimitive, ax as getPropertyFromItem, ab as pick, W as deepEqual, ah as useBorder, Z as useDensity, aa as useDimension, ai as useElevation, bS as useNested, J as provideDefaults, O as makeElevationProps, ac as makeDimensionProps, P as makeDensityProps, Q as makeBorderProps, bT as makeNestedProps, V as EventProp, S as IconValue, bp as focusChild, $ as wrapInArray, ak as useSize, M as makeSizeProps, al as useLink, ar as makeRouterProps, R as Ripple, bU as VMenuSymbol, bV as isClickInsideElement, ag as focusableChildren, bW as getNextElement, bA as VListItemTitle, _ as _export_sfc, aJ as VImg, bb as VExpandTransition, bd as useSsrBoot, bX as breakpoints, bY as CircularBuffer, H as useDisplay, bZ as useRouter$3, b_ as toPhysical, bl as useDelay, af as makeDisplayProps, b4 as makeDelayProps, aI as useCompanyStore, aH as useShipStore } from "../__federation_expose_SideMenuItem/__federation_expose_SideMenuItem-CNhxUVGh.js";
  ...
  setup(props, _ref) {
    ...
    useRender(() => _createVNode$m(props.tag, {
      ...
      default: () => [props.stream && _createElementVNode$f("div", {
        ...
        "class": _normalizeClass$c(["v-progress-linear__background", backgroundColorClasses.value]),
        "style": _normalizeStyle$a([backgroundColorStyles.value, {
          opacity: parseFloat(props.bgOpacity),
          width: props.stream ? 0 : void 0
        }])
      }, null), _createElementVNode$f("div", {
        "class": _normalizeClass$c(["v-progress-linear__buffer", bufferColorClasses.value]),
        ...
        default: () => [!props.indeterminate ? _createElementVNode$f("div", {
          "class": _normalizeClass$c(["v-progress-linear__determinate", barColorClasses.value]),
          ...
          "key": bar,
          "class": _normalizeClass$c(["v-progress-linear__indeterminate", bar, barColorClasses.value]),
          "style": _normalizeStyle$a(barColorStyles.value)
        }, null))])]
...
const { computed: computed$i, inject: inject$2, mergeProps: mergeProps$2, nextTick: nextTick$4, onMounted: onMounted$6, onScopeDispose: onScopeDispose$1, ref: ref$b, shallowRef: shallowRef$9, watch: watch$9, watchEffect: watchEffect$4 } = await importShared("vue");
...
const { mergeProps: mergeProps$1 } = await importShared("vue");
      ...
      return ((_a = slots.default) == null ? void 0 : _a.call(slots)) ?? ((_b = props.items) == null ? void 0 : _b.map((_ref2) => {
        ...
        return children ? _createVNode$h(VListGroup, _mergeProps$6(listGroupProps, {
          ...
          activator: (_ref3) => {
            ...
            const listItemProps = mergeProps$1(itemProps, activatorProps, {
...
const VBtnGroup = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    provideDefaults({
      VBtn: {
        height: toRef$7(() => props.direction === "horizontal" ? "auto" : null),
    ...
    useRender(() => {
      return _createVNode$e(props.tag, {
        "class": _normalizeClass$8(["v-btn-group", `v-btn-group--${props.direction}`, {
          ...
          default: _withCtx$1(() => [
            _createVNode$7(VIcon, { class: "mr-1" }, {
              default: _withCtx$1(() => [..._cache[2] || (_cache[2] = [
                _createTextVNode("mdi-translate", -1)
              ])]),
              _: 1
            }),
                  ...
                  default: _withCtx$1(() => [
                    _createVNode$7(VListItemTitle, null, {
                      default: _withCtx$1(() => [..._cache[3] || (_cache[3] = [
                        _createTextVNode("User profile", -1)
                      ])]),
                      _: 1
                    })
                  ]),
...
const VToolbar = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const isExtended = shallowRef$5(props.extended === null ? !!((_a = slots.extension) == null ? void 0 : _a.call(slots)) : props.extended);
...
const SideNaviLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-429ee422"]]);
export {
  makePositionProps as A,
  makeLocationProps as B,
  required as C,
  passwordRule as D,
  VContainer as E,
  VRow as F,
  VCol as G,
  makeVDividerProps as H,
  VProgressCircular as I,
  VBtnToggleSymbol as J,
  VProgressLinear as K,
  LoaderSlot as L,
  transformItem$1 as M,
  useIntersectionObserver as N,
  VSnackbar as O,
  makeVSnackbarProps as P,
  makeVMenuProps as Q,
  useListItems as R,
  makeVListProps as S,
  VAppBar as T,
  ...
  VDialogTransition as n,
  makeItemsProps as o,
  makeVBtnProps as p,
  makeVToolbarTitleProps as q,
  VToolbarTitle as r,
  useLayoutItem as s,
  makeLayoutItemProps as t,
